...
static void		printPermutation( num_t*, int );
...
/*
  Print the given permutation in both
  1-based and 0-based counting
 */
static void
printPermutation( num_t* strip, int N )
{
	int			i;
	int			numAbove;

	/*
	  1-based counting. Numbers in original order
	 */
	for ( i = 1; i <= N; i++ )
	{
		printf( "%3d ", i );
	...
	/*
	  0-based counting. Numbers in original order
	 */
	for ( i = 0; i < N; i++ )
	{
		printf( "%3d ", i );
...
/*
  The variable 'n' below can always be
  initialized with less readable:
