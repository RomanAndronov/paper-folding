/*
   ...
   stack after a 2^n-strip of paper has been
   folded in half onto itself n times
*/
...
main( int argc, char* argv[] )
{
	...
	/*
	  The first argument is a 1-based square number
	 */
	errno = 0;
	...
	/*
	  The second argument is N, the number of folds
	 */
	errno = 0;
